...
class ProductDaoRepositoryTest {
    ...
    private final ProductDaoRepository productDaoRepository = new ProductDaoRepositoryImpl();
    ...
    void findById() {
        ...
        Assertions.assertEquals(product, productDaoRepository.findById(15).get());
    }

    @Test
    void findAll() {
        int pageSize = 30;
        List<Product> products = productDaoRepository.findAll(pageSize, DEFAULT_PAGE);
    ...
    void add() {
        ...
        productDaoRepository.add(product);
    ...
    void update() {
        ...
        productDaoRepository.update(product, 36);
        System.out.println(product);
    }
    ...
    @Disabled
    void delete() {
        productDaoRepository.delete(36);
    }
}